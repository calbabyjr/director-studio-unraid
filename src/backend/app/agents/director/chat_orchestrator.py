...
- queue_prop_design  {"name":"...","description":"...","generation_prompt":"...","source_asset_id":"...","file_key":"...","image_index":1}  // extract/generate a standalone prop from a library still or chat upload; never use queue_actor_design for objects
